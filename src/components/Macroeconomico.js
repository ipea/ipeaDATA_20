        ...
        return (
                <div className="Ipeadata">
                    ...
                    <div className="col-sm-9 col-sm-offset-2">
                        <Tabs item1= "O que é" item2= "Equipe Responsábel" item3="Metadados"
                         item4="Direitos de uso"  item5="Dicas"  item6="links"  item7="Fale Conosco"
                        tabname1="Ipeadata" tabcolor1="dropdown4" tabname2="Regional"  tabcolor2="dropdown2" tabname3="Social" tabcolor3="dropdown3"  />
                    </div>
